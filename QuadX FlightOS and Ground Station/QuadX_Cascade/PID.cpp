...
PIDController::PIDController(double _Kp, double _Ki, double _Kd, int InputFilter, int DFilter, int Integral_Limit)
{
...
void PIDController::init(double _Kp, double _Ki, double _Kd, int InputFilter, int DFilter, int Integral_Limit)
{
	InputFilter_term = InputFilter;
	DFilter_term = DFilter;
...
double PIDController::getSignal(double input_value, double sensor_value)
{
	...
	double error = input_value - inputFiltered;
        ...
        //Scale Down for Processor Resolution
	integral += 0.01*error;
...
double PIDController::getSignal(double input_value, double sensor_value, double sensor_rate_value)
{
	iTerm[4] = iTerm[3];
	iTerm[3] = iTerm[2];
	iTerm[2] = iTerm[1];
